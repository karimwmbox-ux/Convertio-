      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-bold text-indigo-400 transition-all",
              isGenerating ? "cursor-not-allowed opacity-70" : "hover:bg-indigo-500/20"
            )}
          >
            {isGenerating ? (
