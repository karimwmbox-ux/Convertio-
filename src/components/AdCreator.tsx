      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-all text-[10px] font-bold",
              isGenerating
                ? "bg-indigo-500/10 border-indigo-500/30 text-indigo-400 cursor-not-allowed"
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[10px] font-bold",
                (ad.body || '').length > 125 ? "text-red-500 animate-pulse" : (ad.body || '').length >= 100 ? "text-orange-500" : "text-gray-500"
              )}>
                {(ad.body || '').length}/125
              </span>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[10px] font-bold",
                (ad.headline || '').length > 40 ? "text-red-500 animate-pulse" : (ad.headline || '').length >= 32 ? "text-orange-500" : "text-gray-500"
              )}>
