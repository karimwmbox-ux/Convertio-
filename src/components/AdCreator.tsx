        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-medium ${(ad.body?.length || 0) > 125 ? 'text-amber-400' : 'text-gray-500'}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-medium ${(ad.headline?.length || 0) > 40 ? 'text-amber-400' : 'text-gray-500'}`}>
