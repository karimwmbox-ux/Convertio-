        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold ${ad.body && ad.body.length > 125 ? 'text-red-500' : ad.body && ad.body.length >= 100 ? 'text-orange-400' : 'text-gray-500'}`}>
                {(ad.body || '').length}/125
              </span>
            </div>
            <textarea
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold ${ad.headline && ad.headline.length > 40 ? 'text-red-500' : ad.headline && ad.headline.length >= 32 ? 'text-orange-400' : 'text-gray-500'}`}>
