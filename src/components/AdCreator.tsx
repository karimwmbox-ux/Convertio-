    ...
    <div className="grid lg:grid-cols-2 gap-8 items-start">
      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor={nameId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5">Ad Name</label>
            <input
              id={nameId}
              name="name"
              value={ad.name}
          ...
          <div>
            <label htmlFor={bodyId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 flex items-center gap-1.5">
          ...
          <div>
            <label htmlFor={headlineId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5">Headline</label>
            <input
              id={headlineId}
              name="headline"
              value={ad.headline}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor={ctaId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5">Call to Action</label>
              <select
                id={ctaId}
                name="cta"
                value={ad.cta}
            ...
            <div>
              <label htmlFor={imageUrlId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 flex items-center gap-1.5">
