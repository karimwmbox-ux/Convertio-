...
const nameId = 'ad-name-input';
const bodyId = 'ad-body-input';
const headlineId = 'ad-headline-input';
const ctaId = 'ad-cta-input';
const imageUrlId = 'ad-imageurl-input';
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className={`text-[10px] font-mono ${bodyLen > 125 ? 'text-red-400 font-bold' : bodyLen > 100 ? 'text-orange-400' : 'text-gray-500'}`}>
                {bodyLen}/125
              </span>
            </div>
            <textarea
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className={`text-[10px] font-mono ${headlineLen > 40 ? 'text-red-400 font-bold' : headlineLen > 32 ? 'text-orange-400' : 'text-gray-500'}`}>
                {headlineLen}/40
              </span>
            </div>
            <input
