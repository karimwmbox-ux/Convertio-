...
export const AdCreator: React.FC<Props> = ({ onSave, initialData }) => {
  ...
  const getCountColor = (count: number, limit: number) => {
    if (count > limit) return 'text-red-500';
    if (count >= limit * 0.8) return 'text-orange-500';
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-medium ${getCountColor(ad.body?.length || 0, 125)}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-medium ${getCountColor(ad.headline?.length || 0, 40)}`}>
