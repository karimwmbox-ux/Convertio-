...
export const AdCreator: React.FC<Props> = ({ onSave, initialData }) => {
  ...
  const getCls = (l: number, lim: number) => l > lim ? 'text-red-500 font-bold' : l >= lim * 0.8 ? 'text-orange-500 font-bold' : 'text-gray-500';
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] ${getCls(ad.body?.length || 0, 125)}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] ${getCls(ad.headline?.length || 0, 40)}`}>
