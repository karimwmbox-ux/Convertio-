    ...
    <div className="grid lg:grid-cols-2 gap-8 items-start">
      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor={adNameId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 cursor-pointer">Ad Name</label>
            <input
              id={adNameId}
              name="name"
              value={ad.name}
          ...
          <div>
            <label htmlFor={adBodyId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 flex items-center gap-1.5 cursor-pointer">
          ...
          <div>
            <label htmlFor={adHeadlineId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 cursor-pointer">Headline</label>
            <input
              id={adHeadlineId}
              name="headline"
              value={ad.headline}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor={adCtaId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 cursor-pointer">Call to Action</label>
              <select
                id={adCtaId}
                name="cta"
                value={ad.cta}
            ...
            <div>
              <label htmlFor={adImageUrlId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1.5 flex items-center gap-1.5 cursor-pointer">
