...
export const AdCreator: React.FC<Props> = ({ onSave, initialData }) => {
  const defaults = { name: '', headline: '', body: '', cta: 'Learn More', imageUrl: '' };
  const [ad, setAd] = useState<Partial<MetaAd>>({ ...defaults, ...initialData });
  ...
  const headLen = ad.headline?.length || 0;
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold font-mono ${bodyLen > 125 ? "text-red-500" : bodyLen >= 100 ? "text-amber-500" : "text-gray-400"}`}>{bodyLen} / 125</span>
            </div>
            <textarea
              id={bodyId}
              name="body"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold font-mono ${headLen > 40 ? "text-red-500" : headLen >= 32 ? "text-amber-500" : "text-gray-400"}`}>{headLen} / 40</span>
            </div>
            <input
              id={headlineId}
              name="headline"
