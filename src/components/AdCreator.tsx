        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                ...
                (ad.body?.length || 0) > BODY_LIMIT ? "text-red-400" : (ad.body?.length || 0) > BODY_LIMIT * 0.8 ? "text-orange-400" : "text-gray-500"
              )}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[10px] font-bold tracking-wider",
                (ad.headline?.length || 0) > HEADLINE_LIMIT ? "text-red-400" : (ad.headline?.length || 0) > HEADLINE_LIMIT * 0.8 ? "text-orange-400" : "text-gray-500"
              )}>
