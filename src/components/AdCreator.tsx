        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-end mb-1.5">
              ...
              <span className={cn("text-[9px] font-bold", getCharCountColor(ad.body?.length || 0, 125))}>
          ...
          <div>
            <div className="flex justify-between items-end mb-1.5">
              ...
              <span className={cn("text-[9px] font-bold", getCharCountColor(ad.headline?.length || 0, 40))}>
