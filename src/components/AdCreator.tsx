      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            aria-label="Generate ad copy using AI"
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold ${(ad.body?.length || 0) > 125 ? 'text-red-400' : (ad.body?.length || 0) > 100 ? 'text-orange-400' : 'text-gray-500'}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold ${(ad.headline?.length || 0) > 40 ? 'text-red-400' : (ad.headline?.length || 0) > 32 ? 'text-orange-400' : 'text-gray-500'}`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor={imageUrlId} className="text-[10px] font-bold text-gray-400 uppercase tracking-wider flex items-center gap-1.5 cursor-pointer mb-1.5">
