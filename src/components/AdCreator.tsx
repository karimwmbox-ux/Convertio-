        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn("text-[9px] font-mono", (ad.body?.length || 0) > 125 ? "text-red-500 font-bold" : (ad.body?.length || 0) >= 100 ? "text-orange-500 font-medium" : "text-gray-500")}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn("text-[9px] font-mono", (ad.headline?.length || 0) > 40 ? "text-red-500 font-bold" : (ad.headline?.length || 0) >= 32 ? "text-orange-500 font-medium" : "text-gray-500")}>
