        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold ${(ad.body?.length || 0) > 125 ? 'text-red-400' : (ad.body?.length || 0) > 100 ? 'text-amber-400' : 'text-emerald-500/50'}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[10px] font-bold ${(ad.headline?.length || 0) > 40 ? 'text-red-400' : (ad.headline?.length || 0) > 30 ? 'text-amber-400' : 'text-emerald-500/50'}`}>
