      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        <div className="flex items-center justify-between mb-2">
          ...
          >
            {isGenerating ? (
              <>
                <RefreshCw className="w-3 h-3 animate-spin" aria-hidden="true" /> Generating...
              </>
            ) : (
              <>
                <Wand2 className="w-3 h-3" aria-hidden="true" /> Magic Generate
              </>
            )}
          </button>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[9px] font-mono",
                (ad.body?.length || 0) > 125 ? "text-red-400" : (ad.body?.length || 0) > 100 ? "text-orange-400" : "text-gray-500"
              )}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[9px] font-mono",
                (ad.headline?.length || 0) > 40 ? "text-red-400" : (ad.headline?.length || 0) > 30 ? "text-orange-400" : "text-gray-500"
              )}>
