      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-bold text-indigo-400 transition-all ${
              isGenerating ? "opacity-70 cursor-not-allowed" : "hover:bg-indigo-500/20"
            }`}
          >
            {isGenerating ? (
              <>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className="text-[9px] text-gray-500 font-mono">{(ad.body || '').length} chars</span>
            </div>
            <textarea
              id={bodyId}
              name="body"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className="text-[9px] text-gray-500 font-mono">{(ad.headline || '').length} chars</span>
            </div>
            <input
              id={headlineId}
              name="headline"
