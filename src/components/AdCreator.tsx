        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[9px] font-bold ${(ad.body?.length || 0) > 125 ? 'text-red-500' : 'text-gray-500'}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={`text-[9px] font-bold ${(ad.headline?.length || 0) > 40 ? 'text-red-500' : 'text-gray-500'}`}>
