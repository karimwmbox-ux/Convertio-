...
export const AdCreator: React.FC<Props> = ({ onSave, initialData }) => {
  ...
  const bodyCount = ad.body?.length || 0;
  const headlineCount = ad.headline?.length || 0;
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className={`text-[10px] font-mono font-medium ${bodyCount > 125 ? 'text-red-400' : bodyCount >= 100 ? 'text-amber-400' : 'text-gray-500'}`}>
                {bodyCount}/125
              </span>
            </div>
            <textarea
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className={`text-[10px] font-mono font-medium ${headlineCount > 40 ? 'text-red-400' : headlineCount >= 32 ? 'text-amber-400' : 'text-gray-500'}`}>
                {headlineCount}/40
              </span>
            </div>
            <input
