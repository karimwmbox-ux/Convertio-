      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-bold text-indigo-400 hover:bg-indigo-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px] justify-center"
          >
            {isGenerating ? (
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                ...
                (ad.body?.length || 0) > 125 ? "bg-red-500/20 text-red-400" : (ad.body?.length || 0) > 100 ? "bg-orange-500/20 text-orange-400" : "text-gray-500"
              )}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[9px] font-bold px-1.5 py-0.5 rounded",
                (ad.headline?.length || 0) > 40 ? "bg-red-500/20 text-red-400" : (ad.headline?.length || 0) > 32 ? "bg-orange-500/20 text-orange-400" : "text-gray-500"
              )}>
