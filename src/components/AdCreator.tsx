  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8 items-start">
      ...
      <div className="space-y-6 bg-zinc-950/60 p-8 rounded-3xl border border-white/5">
        ...
        <div className={cn("space-y-4", isSaving && "opacity-50 pointer-events-none")}>
          <div>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[10px] font-bold",
                bodyLength > 125 ? "text-red-500" : bodyLength > 100 ? "text-orange-500" : "text-gray-500"
              )}>
                {bodyLength}/125
              </span>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn(
                "text-[10px] font-bold",
                headlineLength > 40 ? "text-red-500" : headlineLength > 32 ? "text-orange-500" : "text-gray-500"
              )}>
                {headlineLength}/40
              </span>
            </div>
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="w-full py-4 rounded-2xl bg-emerald-500 text-black font-black text-sm hover:bg-emerald-400 transition-all active:scale-95 mt-4 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isSaving ? <RefreshCw className="w-4 h-4 animate-spin" /> : null}
          {isSaving ? 'SAVING...' : 'SAVE AD CREATIVE'}
        </button>
      </div>
