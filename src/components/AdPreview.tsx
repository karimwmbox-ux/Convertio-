    ...
    <div className="max-w-[500px] bg-white text-[#1c1e21] rounded-lg shadow-sm border border-[#dddfe2] font-sans overflow-hidden">
      ...
      <div className="flex items-center justify-between p-3">
        ...
        <button
          ...
          className="text-[#65676b] hover:bg-[#f2f2f2] p-2 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 focus:outline-none"
        >
      ...
      <div className="bg-[#f0f2f5] aspect-[1.91/1] flex items-center justify-center overflow-hidden border-y border-[#dddfe2]">
        {ad.imageUrl ? (
          <img
            src={ad.imageUrl}
            alt={ad.headline || ad.name ? `Ad preview: ${ad.headline || ad.name}` : "Ad creative preview"}
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[#f0f2f5]">
        ...
        <button
          type="button"
          className="px-4 py-2 bg-[#e4e6eb] hover:bg-[#d8dadf] text-[#050505] font-bold text-[15px] rounded-md transition-colors whitespace-nowrap focus-visible:ring-2 focus-visible:ring-blue-500 focus:outline-none"
        >
          {ad.cta || 'Learn More'}
        </button>
      </div>
      ...
      <div className="px-4 py-2 flex items-center justify-between border-t border-[#dddfe2] mx-3 my-1">
        <button
          type="button"
          className="flex items-center gap-1.5 text-[#65676b] text-[15px] font-medium py-1.5 px-2 hover:bg-[#f2f2f2] rounded-md flex-1 justify-center cursor-pointer transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 focus:outline-none"
        >
